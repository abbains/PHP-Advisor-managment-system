...
<body>
  ...
  $allrecords = fetchAllUsersStudent();
  ?>
  ...
  <table class="table-style-three" width="1400px">
      ...
      <tr>
        ...
        <?PHP echo'<td><a href="updateThisUser.php?UserID='.$displayRecords['UserID'].'">Modify | </a><a href="deleteThisUser.php?UserID='.$displayRecords['UserID'].'">Delete</a></td>'; ?>
      </tr>
      <?php } ?>
      </tbody>
  </table>
