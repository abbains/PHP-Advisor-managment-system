...
<tr><td><label>User ID:</label></td><td><input type='text' name='astudent' /></td></tr>
...
$allrecordsAdvisor = listActiveAdvisor(); ?>
...
<table class="table-style-three" align="left" >
    ...
    <?php
    foreach($allrecordsAdvisor as $displayRecords) { ?>
        <tr>
            <td><?php print $displayRecords['UserID']; ?></td>
            <td><?php print $displayRecords['UserName']; ?></td>
