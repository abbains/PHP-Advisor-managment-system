  ...
  <table class="table-style-three" width="1390px" >
      ...
      <tr>
        ...
        <td><?php print $displayRecords['ashow']; ?></td>
          <?PHP echo'<td><a href="updateThisAppt.php?ano='.$displayRecords['ano'].'">Modify |<a href="updateThisAppt_Delete.php?ano='.$displayRecords['ano'].'">Delete </a></td>'; ?>
      </tr>
      <?php } ?>
      </tbody>
  </table>
