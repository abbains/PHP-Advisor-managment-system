...
<div id='left-nav'>";
  ...
  $allrecords = fetchMyConfirmedAppAdvisor();
  ?>
  <h3>Hello Advisor..! All Confirmed Appointment List</h3>
  ...
  <table class="table-style-three" width="1390px">
      ...
      <tr>
        ...
        <td><?php print $displayRecords['ashow']; ?></td>
          <?PHP echo'<td><a href="updateThisAppt.php?ano='.$displayRecords['ano'].'">Modify |
