...
if(!empty($_POST))
{
    ...
    if(count($errors) == 0)
    {
        ...
        $user = createNewUserStudent($username, $firstname, $lastname, $email, $password);
        print_r($user);
        if($user <> 1){
...
<font SIZE=6 color=Green>ADD NEW STUDENT</font></td></tr>
...
<tr height='50px'><td  colspan='2' align='center'><input type='submit' value='Register'/></td></tr>
