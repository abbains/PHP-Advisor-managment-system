...
<div id='left-nav'>";
  ...
  ?>
  <h3>Hello Advisor!All Pending Appointment List</h3>
  ...
  <table class="table-style-three" width="1390px">
      ...
      <tr>
        ...
        <td><?php print $displayRecords['ashow']; ?></td>
          <?PHP echo'<td><a href="updateThisAppt.php?ano='.$displayRecords['ano'].'">Modify | </a><a href="updateThisAppt_Confirm.php?ano='.$displayRecords['ano'].'">Confirm | </a>
        <a href="updateThisAppt_Delete.php?ano='.$displayRecords['ano'].'">Delete </a></td>'; ?>
      </tr>
      <?php } ?>
      </tbody>
  </table>
